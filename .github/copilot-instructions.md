...
│       ├── modules/[module_name]/
│       │   ├── domain/ (L1: Entities, Repo Interfaces)
│       │   ├── application/ (L2: Use Cases, Commands, Queries)
│       │   ├── infrastructure/ (L3: DB Models, MQ, API Clients)
│       │   └── presentation/ (L4: API Views, Serializers)
│       └── tests/
