  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <div className="mb-10">
        ...
        >
          <ChevronLeft size={16} className="mr-1" /> Quay lại Sản phẩm
        </button>
        <h1 className="text-4xl font-black text-gray-900">{product ? 'Chỉnh sửa sản phẩm' : 'Thêm sản phẩm mới'}</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        <div className="lg:col-span-2 space-y-8">
          <div className="bg-white rounded-[40px] p-8 border border-gray-100 shadow-xl shadow-primary/5 space-y-6">
            <div>
              <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-3 ml-1">Tên sản phẩm</label>
            ...
            <div className="grid grid-cols-2 gap-6">
               <div>
                <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-3 ml-1">Danh mục</label>
                <div className="relative">
                  <select
              ...
              <div>
                <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-3 ml-1">Danh mục phụ</label>
                <input
                  type="text"
                  value={formData.subCategory}
                  onChange={(e) => setFormData({ ...formData, subCategory: e.target.value })}
                  placeholder="VD: Tiểu thuyết, Laptop..."
            ...
            <div>
              <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-3 ml-1">Mô tả sản phẩm</label>
              <textarea
                value={formData.description}
                onChange={(e) => setFormData({ ...formData, description: e.target.value })}
                placeholder="Mô tả các đặc tính của sản phẩm..."
          ...
          <div className="bg-white rounded-[40px] p-8 border border-gray-100 shadow-xl shadow-blue-500/5 grid grid-cols-1 md:grid-cols-2 gap-6">
             <div>
                <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-3 ml-1">Xuất xứ</label>
                <div className="relative">
                    <input
                        type="text"
            ...
            <div>
                <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-3 ml-1">Số lượng tồn kho</label>
                <div className="relative">
                    <input
                        type="number"
        ...
        <div className="lg:col-span-1 space-y-8">
           <div className="bg-white rounded-[40px] p-8 border border-gray-100 shadow-xl shadow-blue-500/5">
                <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-4 ml-1">Hình ảnh sản phẩm</label>
           ...
           <div className="bg-primary rounded-[40px] p-8 shadow-xl shadow-primary/20 text-white">
                <label className="block text-[10px] font-black text-primary-light uppercase tracking-widest mb-3 ml-1">Giá bán (VNĐ)</label>
                <div className="relative mb-8">
                    <input
                        ...
                        required
                    />
                    <div className="absolute left-4 top-8 text-primary-light font-bold text-lg">đ</div>
                </div>
